...
*/
SELECT fab.id_fabricante, ale.id_alevino, dis.id_distribuidor, fab.nome_fabricante,ale.prod_ale,ale.sexo,ale.especie,ale.peso_init,ale.data_init,ale.dias_init,
